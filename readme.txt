...
along with direct links to specific facets of each site as you see them. This should take the guesswork out with
determining what code does what and which plugins are being used. I've added some tips below that I ended up
learning along the way of putting this site together, so's to try and help you go through trial & error to see how
things work.
